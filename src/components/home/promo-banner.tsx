  ...
  return (
    <section className="py-16 bg-white">
      <div className="mx-auto max-w-7xl px-4">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-brand-green-deep to-brand-green p-8 md:p-12">
          ...
          <div className="relative z-10 grid items-center gap-8 md:grid-cols-2">
            <div className="text-white">
              ...
              <p className="mt-4 text-lg text-on-dark-soft max-w-md">
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                <Button size="lg" className="bg-white text-brand-green-deep hover:bg-brand-green-soft font-bold" asChild>
            ...
            <div className="hidden md:block">
              <div className="rounded-xl bg-white/10 backdrop-blur p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-on-dark-soft">
                ...
                <p className="mt-3 text-xs text-on-dark-soft">*Incluye ITBMS. Precios referenciales.</p>
              </div>
            </div>
          </div>
        </div>
